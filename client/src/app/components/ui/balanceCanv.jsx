...
const BalanceCanv = ({ arr, info }) => {
    const { createdAt } = useSelector(getCurrentUserData());
    const depArr = [...arr];
    ...
    const sliderContextRef = useRef(null);
    useEffect(() => {
        const canvas = canvRef.current;
        const ctx = canvas.getContext("2d");
        const canvasSlider = sliderRef.current;
        const ctxSlider = canvasSlider.getContext("2d");
        ...
        sliderContextRef.current = ctxSlider;
